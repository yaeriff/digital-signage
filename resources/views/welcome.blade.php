...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('signage/assets/css/steel.css') }}">
        ...
        <div class="content-wrapper d-flex flex-grow-1 overflow-hidden">
            <div class="col-left d-flex flex-column" style="width: 50%;">
                ...
                <div class="video-section bg-black position-relative" style="height: 50%;">
                    <div id="dynamic-content" class="w-100 h-100 d-flex justify-content-center align-items-center">
                        @if($video)
                            @if(Str::contains($video->file_path, 'youtube.com') || Str::contains($video->file_path, 'youtu.be'))
                                <iframe src="https://www.youtube.com/embed/{{ \Str::afterLast($video->file_path, '/') }}?autoplay=1&mute=1&controls=0&loop=1&playlist={{ \Str::afterLast($video->file_path, '/') }}" allow="autoplay; encrypted-media"></iframe>
                            @else
